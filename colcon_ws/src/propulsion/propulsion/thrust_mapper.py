...
class ThrustMapper(Node):
    def __init__(self):
        ...
        self.declare_parameter("thruster_lower_limit", rclpy.Parameter.Type.INTEGER)
        self.declare_parameter("thruster_upper_limit", rclpy.Parameter.Type.INTEGER)
        ...
        self.thruster_lower_limit = self.get_parameter("thruster_lower_limit").get_parameter_value().integer_value
        self.thruster_upper_limit = self.get_parameter("thruster_upper_limit").get_parameter_value().integer_value
    ...
    def forces_to_pwm_publisher(self, forces_msg):
        ...
        pwm_msg = ThrusterMicroseconds(microseconds=pwm_arr)
