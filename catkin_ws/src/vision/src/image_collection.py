...
if __name__ == "__main__":
     ...
     front_cam_image_sub = rospy.Subscriber('/vision/front_cam/color/image_raw', Image, front_cam_image_callback) 
     down_cam_image_sub = rospy.Subscriber('/vision/down_cam/image_raw', Image, down_cam_image_callback)
     ...
     while not rospy.is_shutdown():
          ...
          if usr_choice == "z": save_image(front_cam_data_dir, is_front_cam=True)
          elif usr_choice == "x": save_image(down_cam_data_dir, is_front_cam=False)
