...
from dof_states import Surge, Yaw, Pause, changeZ, Pitch, Roll
...
if __name__ == '__main__':
    ...
    with sm:
        ...
        smach.StateMachine.add('descend1', changeZ(setpoint=-2.0),
        ...
        smach.StateMachine.add('ascend1', changeZ(setpoint=0.0,duration=10.0),
