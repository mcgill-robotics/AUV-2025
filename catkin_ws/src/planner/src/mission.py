...
def testControllerMission(testsToPerform=[0,1,2,3,4,5,6,7,8]):
    ...
    if 6 in testsToPerform:
        ...
        for i in range(5):
            print("Increasing angular velocity by (0,0,2).")
            control.deltaAngularVelocity((0,0,2*i))
            rospy.sleep(1)
        print("Setting angular velocity to (0,0,0).")
        control.angularVelocity((0,0,0))
    ...
    if 9 in testsToPerform:
        ...
        print("Setting delta world velocity to (1,0,0).")
        control.deltaVelocity((1,0,0))
        rospy.sleep(2)
        print("Setting delta world velocity to (0,0,0).")
        control.deltaVelocity((0,0,0))
        rospy.sleep(2)
        print("Setting local velocity to (0,0,0).")
        control.velocity((0,0,0))
    ...
    if 10 in testsToPerform:
        ...
        print("Descending 1 meters.")
        control.moveDelta((0, 0, -1.0))
        print("Setting delta local velocity to (1,0,0).")
        control.deltaVelocityLocal((1,0,0))
        rospy.sleep(2)
        print("Setting delta local velocity to (0,0,0).")
        control.deltaVelocityLocal((0,0,0))
        rospy.sleep(2)
        print("Setting local velocity to (0,0,0).")
        control.velocityLocal((0,0,0))
