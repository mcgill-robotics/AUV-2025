...
public:
    WaterLinkedDriver() : nh_(), pnh_("~")
    {
        ...
        pub_twist_ = nh_.advertise<geometry_msgs::TwistWithCovarianceStamped>("/sensors/dvl/twist", 20);
        pub_pose_ = nh_.advertise<geometry_msgs::PoseWithCovarianceStamped>("/sensors/dvl/pose", 20);
        ...
        pnh_.param<bool>("publish_dr_pose", publish_dr_pose_, true);
    }
    ...
    {
        while (ros::ok())
        { // TODO: add timeout to prevent infinite loop
