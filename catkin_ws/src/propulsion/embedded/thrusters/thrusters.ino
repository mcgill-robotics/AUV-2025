...
void commandCb(propulsion::ThrusterCommand thrusterCmd){
	uint16_t command[] = thrusterCmd.command;
...
ros::NodeHandle nh;
ros::Subscriber<propulsion::ThrusterCommand> sub("propulsion/thruster_cmd", &commandCb);
