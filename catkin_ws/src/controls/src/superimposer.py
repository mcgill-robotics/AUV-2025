...
thrust_decay = rospy.get_param('controls/thrust_decay', 1.0) #TODO - create thrust_decay parameter
...
if __name__ == '__main__':
    rospy.init_node('controls') #TODO - should node be called superimposer
