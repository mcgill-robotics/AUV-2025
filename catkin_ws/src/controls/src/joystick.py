...
while not rospy.is_shutdown():
    ...
    while True:
        ...
        if keyboard.is_pressed("w"):
            desired_effort.force.x = desired_effort.force.x + force_amt * MAX_FWD_FORCE
        if keyboard.is_pressed("s"):
            desired_effort.force.x = desired_effort.force.x - force_amt * MAX_BKWD_FORCE
        if keyboard.is_pressed("a"):
            desired_effort.force.y = desired_effort.force.y + force_amt * MAX_FWD_FORCE
        if keyboard.is_pressed("d"):
            desired_effort.force.y = desired_effort.force.y - force_amt * MAX_BKWD_FORCE
        if keyboard.is_pressed("q"):
            desired_effort.force.z = desired_effort.force.z + force_amt * MAX_FWD_FORCE
        if keyboard.is_pressed("e"):
            desired_effort.force.z = desired_effort.force.z - force_amt * MAX_BKWD_FORCE
